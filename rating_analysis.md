...
| 변수명 | 설명 |
| :--- | :--- |
| `rating_guestSatisfaction` | **종합 만족도**; 숙소 전반적인 경험에 대한 종합 평가 (5점 만점) |
| `rating_accuracy` | **정확성**; 숙소 사진, 정보와 실제 시설의 일치 여부 |
| `rating_cleanliness` | **청결도**; 침구, 욕실 등 숙소의 위생 및 청결 상태 |
| `rating_checking` | **체크인 편의성**; 비밀번호, 스마트록 안내 등 체크인 과정의 원활함 |
| `rating_communication` | **의사소통**; 호스트의 메시지 응대 속도와 친절도 |
| `rating_location` | **위치**; 대중교통 접근성 및 주변 환경 등 입지 만족도 |
| `rating_value` | **가성비**; 숙박 요금 대비 숙소 수준과 서비스의 합리성 |
| `rating_reviewsCount` | **총 리뷰 수**; 게스트가 남긴 누적 리뷰 수 |
...
3. `rating_reviewsCount`(리뷰 수)가 적은 숙소는 제외하고 분석을 해야 할까?
